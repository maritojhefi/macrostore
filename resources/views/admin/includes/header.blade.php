            ...
            <nav class="navbar">
                ...
                <div class="d-flex">
                    ...
                    <a href="../index.html" class="brand-icon d-flex align-items-center mx-2 mx-sm-3 text-primary">
                       <img src="{{asset('img/macrobyte-logo2.png')}}" width="35px" alt="">
                    </a>
                </div>

                <div class="header-left flex-grow-1 d-none d-md-block">
                    <div class="main-search px-3 flex-fill">
                        <input class="form-control" type="text" placeholder="Busca algo">
                        <div class="card shadow rounded-4 search-result slidedown">
                            <div class="card-body">
                                <small class="text-uppercase text-muted">Busquedas Recientes</small>
                                ...
                                <small class="text-uppercase text-muted">Sugerencias</small>
                            ...
                            <div id="NotificationsDiv" class="dropdown-menu shadow rounded-4 border-0 p-0 m-0">
                                <div class="card w380">
                                    ...
                                    <ul class="nav nav-tabs tab-card d-flex text-center" role="tablist">
                                        <li class="nav-item flex-fill" role="presentation"><a
                                                class="nav-link active" data-bs-toggle="tab"
                                                href="#Noti-tab-Message" role="tab"
                                                aria-selected="true">Message</a></li>
                                        <li class="nav-item flex-fill" role="presentation"><a class="nav-link"
                                                data-bs-toggle="tab" href="#Noti-tab-Events" role="tab"
                                                aria-selected="false" tabindex="-1">Events</a></li>
                                        <li class="nav-item flex-fill" role="presentation"><a class="nav-link"
                                                data-bs-toggle="tab" href="#Noti-tab-Logs" role="tab"
                                                aria-selected="false" tabindex="-1">Logs</a></li>
                                    </ul>
